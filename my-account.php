            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-9 order-lg-last dashboard-content">
                        ...
                        <?php $sql = "SELECT * FROM customer WHERE phone = '" . $_SESSION['acc-firstname'] . "'";
                        $result = mysqli_query($db, $sql);



                        while ($row = mysqli_fetch_array($result)) {
                            echo "Hello, " . $row['fname'] . " (" . $row['phone'] . ").";
                        ?>
                            <form action="#">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group required-field">
                                                    ...
                                                    <input type="text" value="<?php echo $row['fname'] ?>" class="form-control" id="acc-name" name="acc-name" required>
                                                </div><!-- End .form-group -->
                                            </div><!-- End .col-md-4 -->
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group required-field">
                                                    ...
                                                    <input type="text" value="<?php echo $row['lname'] ?>" class="form-control" id="acc-lastname" name="acc-lastname" required>
                                                </div><!-- End .form-group -->
                                            </div><!-- End .col-md-4 -->
                                ...
                                <div class="form-group required-field">
                                    ...
                                    <input type="email" value="<?php echo $row['email'] ?>" class="form-control" id="acc-email" name="acc-email" required>
                                </div><!-- End .form-group -->

                                <div class="form-group required-field">
                                    <label for="acc-region">Region</label>
                                    <input type="text" value="<?php echo $row['region'] ?>" class="form-control" id="acc-region" name="acc-region" required>
                                </div><!-- End .form-group -->

                                <div class="form-group required-field">
                                    <label for="acc-city">City</label>
                                    <input type="text" value="<?php echo $row['city'] ?>" class="form-control" id="acc-city" name="acc-city" required>
                                </div><!-- End .form-group -->

                                <div class="form-group required-field">
                                    <label for="acc-password">Password</label>
                                    <input type="password" value="<?php echo $row['fname'] ?>" class="form-control" id="acc-password" name="acc-password" required>
                                </div><!-- End .form-group -->
