                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row product-adding">
                                        <div class="col-xl-7">
                                            <form class="needs-validation add-product-form" novalidate="" enctype="multipart/form-data" method="POST" action="add-product.php">
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-sm-4" for="product_name">Product Name :</label>
                                                    <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                                                        <input class="form-control col-xl-8 col-sm-7" id="product_name" name="product_name" type="text" required="" />
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-sm-4" for="product_price">Price :</label>
                                                    <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                                                        <input class="form-control col-xl-8 col-sm-7" id="product_price" name="product_price" type="text" required="" />
                                                        <div class="valid-feedback">Looks good!</div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form">
                                                    <div class="form-group row">
                                                        <label for="category_name" class="col-xl-3 col-sm-4 mb-0">Select Category :</label>
                                                        <div class="valid-feedback">Looks good!</div>
                                                        <select class="form-control digits col-xl-8 col-sm-7" id="category_name" name="category_name">
                                                            <?php
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-sm-4 mb-0" for="product_quantity">Products Quantity :</label>
                                                        <fieldset class="qty-box col-xl-9 col-xl-8 col-sm-7 pl-0">
                                                            <div class="input-group">
                                                                <input id="product_quantity" name="product_quantity" class="touchspin" type="text" value="1" />
                                                            </div>
                                                            <div class="valid-feedback">Looks good!</div>
                                                        </fieldset>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-sm-4" for="product_description">Add Description :</label>
                                                        <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                                                            <textarea class="form-control" name="product_description" id="product_description" type="text" required="" rows="3"></textarea>
                                                            <div class="valid-feedback">Looks good!</div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-xl-3 col-sm-4" for="image">Upload Image :</label>
                                                        <div class="col-xl-8 col-sm-7 pl-0 description-sm">
                                                            <input name="product_image" type="file" class="form-control-file" id="product_image" required="" />
                                                            <div class="valid-feedback">Looks good!</div>
                                                        </div>
                                                    </div>
                                                </div>
