        ...
        <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                ...
                <ul class="sidebar-menu">
                    <li><a class="sidebar-header" href="admin.php"><i data-feather="home"></i><span>Dashboard</span></a></li>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form class="needs-validation" action="insert_category.php" method="post">
                                                        <div class="form">
                                                            <div class="form-group">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 footer-copyright">
                        <p class="mb-0">Copyright 2020 © Multikart All rights reserved.</p>
                    </div>
                    <div class="col-md-6">
