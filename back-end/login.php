            ...
            <div class="card tab2-card">
              <div class="card-body">
                <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" id="contact-top-tab" data-toggle="tab" href="#top-contact" role="tab" aria-controls="top-contact" aria-selected="true"><i class="fa fa-user" aria-hidden="true"></i> Login</a>
                  </li>
                </ul>
                ...
                <div class="tab-content" id="top-tabContent">
                  <div class="tab-pane fade show active" id="top-profile" role="tabpanel" aria-labelledby="top-profile-tab">
                    <form class="auth-form">
                      <div class="form-group">
                        <input required="" name="username" type="text" id="username" class="form-control" placeholder="Username" />
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-button">
                        <button type="button" name="button" id="login" class="btn btn-primary login_btn">
                          Login
                        </button>
                      </div>
                    </form>
