  ...
  var t = {
    ...
    mMenuIcons: function () {
      e(".mobile-menu")
        ...
        .each(function () {
          var t = e(this);
          t.find("ul").length &&
            e("<span/>", { class: "mmenu-btn" }).appendTo(t.children("a"));
        });
    },
    mobileMenu: function () {
    ...
    owlCarousels: function () {
      ...
      o.owlCarousel(
        ...
        e(".new-arrivals-products").owlCarousel(
          e.extend(!0, {}, t, {
            loop: !1,
            margin: 20,
            nav: !0,
        ...
        e(".product-single-extended .product-single-carousel").owlCarousel(
          e.extend(!0, {}, t, {
            dots: !1,
            autoplay: !1,
            responsive: {
    ...
    tooltip: function () {
      e.fn.tooltip &&
        e('[data-toggle="tooltip"]').tooltip({ trigger: "hover focus" });
    },
    popover: function () {
      e.fn.popover &&
      ...
      i.each(function () {
        ...
        e(".prod-full-screen").click(function (t) {
          ...
          (n = t.currentTarget.closest(".product-slider-container")
            ? (e(".product-single-carousel").data("owl.carousel").current() +
                i.length -
          ...
          e.magnificPopup.open({
            ...
            callbacks: {
              open: function () {
                var t =
                  Number(
                    e(".sticky-header.fixed").css("margin-right").slice(0, -2)
                  ) +
                  17 +
                  "px";
                e(".sticky-header.fixed").css("margin-right", t),
      ...
      e("body").on("click", ".btn-add-cart", function (t) {
        if (
          (e(".add-cart-box #productImage").attr(
            "src",
            e(this).parents(".product-default").find("figure img").attr("src")
          ),
          e(".add-cart-box #productTitle").text(
            e(this).parents(".product-default").find(".product-title").text()
          ),
          e(".sticky-header.fixed").css("margin-right"))
        ) {
          var o =
            Number(e(".sticky-header.fixed").css("margin-right").slice(0, -2)) +
            17 +
            "px";
          e(".sticky-header.fixed").css("margin-right", o),
            e(".sticky-header.fixed-nav").css("margin-right", o),
            e("#scroll-top").css("margin-right", o);
        }
      }),
